...
describe("district mapping for future events", () => {
  it("maps every future venue to a known district", () => {
    ...
    const expected: Record<string, string> = {
      ...
      "Chunati Meherunnesa Secondary School": "Chattogram",
      ...
      "Hatirjheel Amphitheater, Dhaka": "Dhaka",
      "Hatirjheel Amphitheatre, Dhaka": "Dhaka",
      "Hatirjheel Amphitheatre - হাতিরঝিল এম্ফি থিয়েটার": "Dhaka",
      "Hatirjheel, Dhaka": "Dhaka",
      "Kuakata Sea Beach, Patuakhali": "Patuakhali",
      "Mayabini Lake, Khagrachari": "Khagrachhari",
      "Mohiskhola, Madhanagar, Sunamganj": "Sunamganj",
      ...
      "Tareng Chumui, Khagrachhari": "Khagrachhari",
      "Uttara, Dhaka": "Dhaka",
